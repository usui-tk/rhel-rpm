...
Source0:        http://cache.ruby-lang.org/pub/%{name}/%{major_minor_version}/ruby-%{ruby_version}-p%{patch_level}.tar.gz
#Source0:       http://cache.ruby-lang.org/pub/ruby/1.9/ruby-1.9.3-p545.tar.gz
...
%prep
%setup -n ruby-%{ruby_version}-p%{patch_level}
...
* Wed Mar 26 2014 Takayuki Usui <usui.takayuki@po.ntts.co.jp> - 1.9.3-p545
- Initial spec to replace system Ruby with 1.9.3-p545
